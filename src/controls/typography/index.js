...
const MyTypographyControl = ({label, typography, onChange, }) => {
	...
	return (
		<div className="bwddhb-typography-wrapper">
			<div id="typography-control">
				{label ? label : __('Typography', 'duo-head-block')}
			</div>
			<Button
			...
			{showTypography && (
				...
				>
					<BaseControl>
						<SelectControl
							label={__('Font Family', 'duo-head-block')}
							value={fontFamily}
							options={fontOptions}
							onChange={(value) =>
						...
						/>
						<SelectControl
							label={__('Font Weight', 'duo-head-block')}
							value={fontWeight}
						...
						/>
						<SelectControl
							label={__('Font Style', 'duo-head-block')}
							value={fontStyle}
						...
						/>
						<SelectControl
							label={__('Text Transform', 'duo-head-block')}
							value={textTransform}
						...
						/>
						<RangeControl
							label={__('Line Height', 'duo-head-block')}
							value={lineHeight}
							onChange={(value) =>
						...
						/>
						<RangeControl
							label={__('Word Spacing (px)', 'duo-head-block')}
							value={wordSpacing}
							onChange={(value) =>
